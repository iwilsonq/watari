...
var m = require("object-assign"),
  ...
  for (var b = arguments.length - 1, e = "http://reactjs.org/docs/error-decoder.html?invariant\x3d" + a, c = 0; c < b; c++) e += "\x26args[]\x3d" + encodeURIComponent(arguments[c + 1]);n(!1, "Minified React error #" + a + "; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ", e);
...
function E(a, b, e) {
  ...
  "object" !== typeof a && "function" !== typeof a && null != a ? C("85") : void 0;this.updater.enqueueSetState(this, a, b, "setState");
...
function L(a, b, e) {
  var c = void 0,
      d = {},
      g = null,
      h = null;if (null != b) for (c in void 0 !== b.ref && (h = b.ref), void 0 !== b.key && (g = "" + b.key), b) J.call(b, c) && !K.hasOwnProperty(c) && (d[c] = b[c]);var f = arguments.length - 2;if (1 === f) d.children = e;else if (1 < f) {
    for (var k = Array(f), l = 0; l < f; l++) k[l] = arguments[l + 2];d.children = k;
  }if (a && a.defaultProps) for (c in f = a.defaultProps, f) void 0 === d[c] && (d[c] = f[c]);return { $$typeof: t, type: a, key: g, ref: h, props: d, _owner: I.current };
}
function M(a) {
...
function R(a, b, e, c) {
  ...
  } else if (null === a || "undefined" === typeof a ? f = null : (f = B && a[B] || a["@@iterator"], f = "function" === typeof f ? f : null), "function" === typeof f) for (a = f.call(a), h = 0; !(d = a.next()).done;) d = d.value, f = b + S(d, h++), g += R(d, f, e, c);else "object" === d && (e = "" + a, C("31", "[object Object]" === e ? "object with keys {" + Object.keys(a).join(", ") + "}" : e, ""));return g;
}function S(a, b) {
...
var W = { Children: { map: function (a, b, e) {
    ...
    null === a || void 0 === a ? C("267", a) : void 0;var c = void 0,
      ...
      void 0 !== b.ref && (h = b.ref, f = I.current);void 0 !== b.key && (g = "" + b.key);var k = void 0;a.type && a.type.defaultProps && (k = a.type.defaultProps);for (c in b) J.call(b, c) && !K.hasOwnProperty(c) && (d[c] = void 0 === b[c] && void 0 !== k ? k[c] : b[c]);
...
},{"object-assign":18,"fbjs/lib/invariant":21,"fbjs/lib/emptyObject":19,"fbjs/lib/emptyFunction":20}],26:[function(require,module,exports) {
/**
...
},{"fbjs/lib/invariant":21,"fbjs/lib/warning":26,"./lib/ReactPropTypesSecret":37}],11:[function(require,module,exports) {
/** @license React v16.3.2
...
},{"object-assign":18,"fbjs/lib/invariant":21,"fbjs/lib/emptyObject":19,"fbjs/lib/warning":26,"fbjs/lib/emptyFunction":20,"prop-types/checkPropTypes":33}],7:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.production.min.js":10,"./cjs/react.development.js":11}],27:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isTextNode":35}],12:[function(require,module,exports) {
/** @license React v16.3.2
...
},{"fbjs/lib/invariant":21,"react":7,"fbjs/lib/ExecutionEnvironment":27,"object-assign":18,"fbjs/lib/emptyFunction":20,"fbjs/lib/getActiveElement":28,"fbjs/lib/shallowEqual":29,"fbjs/lib/containsNode":30,"fbjs/lib/emptyObject":19}],34:[function(require,module,exports) {
'use strict';
...
},{"fbjs/lib/invariant":21,"react":7,"fbjs/lib/warning":26,"fbjs/lib/ExecutionEnvironment":27,"object-assign":18,"fbjs/lib/emptyFunction":20,"prop-types/checkPropTypes":33,"fbjs/lib/getActiveElement":28,"fbjs/lib/shallowEqual":29,"fbjs/lib/containsNode":30,"fbjs/lib/emptyObject":19,"fbjs/lib/hyphenateStyleName":31,"fbjs/lib/camelizeStyleName":32}],6:[function(require,module,exports) {
'use strict';
...
},{"react":7,"react-dom":6}],39:[function(require,module,exports) {
...
//# sourceMappingURL=/client.9d8b6dc0.map